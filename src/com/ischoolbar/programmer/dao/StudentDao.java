...
public class StudentDao extends BaseDao {
	public boolean addStudent(Student student){
		...
		sql += ",'" + student.getHeight() + "'," + student.getWeight();
		sql += ",'" + student.getSex() + "','" + student.getMobile() + "'";
		sql += ",'" + student.getQq() + "','"+ student.getDescription() +  "',null)";
		return update(sql);
	}
	...
	public Student getStudent(int id){
		...
		try {
			if(resultSet.next()){
				...
				student.setHeight(resultSet.getString("weight"));
	...
	public List<Student> getStudentList(Student student,Page page){
		...
		try {
			while(resultSet.next()){
				...
				s.setWeight(resultSet.getString("weight"));
				s.setHeight(resultSet.getString("height"));
	...
	public Student login(String name ,String password){
		...
		try {
			if(resultSet.next()){
				...
				student.setPhoto(resultSet.getBinaryStream("photo"));
				student.setQq(resultSet.getString("qq"));
				student.setWeight(resultSet.getString("weight"));
				student.setHeight(resultSet.getString("height"));
				student.setDescription(resultSet.getString("description"));
				student.setSex(resultSet.getString("sex"));
				student.setSn(resultSet.getString("sn"));
