	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'description',title:'评价',width:150},
	    ...
	    $("#editDialog").dialog({
			...
			onBeforeOpen: function(){
				...
				$("#edit_height").textbox('setValue', selectRow.height);
	...
	<div id="addDialog" style="padding: 10px">  
    	...
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>身高:</td>
	    			<td><input id="add_height" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="height" data-options="required:true, missingMessage:'请填写学生身高'" /></td>
	    		</tr>
	    		
	    		<tr>
	    			<td>体重:</td>
	    			<td><input id="add_weight" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="weight" data-options="required:true, missingMessage:'请填写学生体重'"/></td>
	    		</tr>
	    		
	    		<tr>
	    			<td>评价:</td>
	    			<td><input id="add_description" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="description" data-options="required:true, missingMessage:'请填写学生评价'"/></td>
	    		</tr>
	...
	<div id="editDialog" style="padding: 10px">
    	...
    	<form id="editForm" method="post">
	    	...
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>身高:</td>
	    			<td><input id="edit_height" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="height" data-options="required:true, missingMessage:'请填写学生身高'"/></td>
	    		</tr>
	    		
	    		<tr>
	    			<td>体重:</td>
	    			<td><input id="edit_weight" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="weight" data-options="required:true, missingMessage:'请填写学生体重'" /></td>
	    		</tr>
	    		
	    		
	    		<tr>
	    			<td>学生评价:</td>
	    			<td><input id="edit_description" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="description" data-options="required:true, missingMessage:'请填写学生评价'"/></td>
	    		</tr>
